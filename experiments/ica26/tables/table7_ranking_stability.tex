...
PlantVillage in-domain & all & STABLE: 2/2 seeds give EfficientNet-B0 $>$ MobileNetV3-Small $>$ ResNet-50 & 0.9912 & 0.9950 & 0.9929 \\
...
PlantVillage $\rightarrow$ PlantDoc Core & all & UNSTABLE: 1/2 seeds give EfficientNet-B0 $>$ ResNet-50 $>$ MobileNetV3-Small & 0.2316 & 0.2335 & 0.1873 \\
...
PlantDoc Core in-domain & all & STABLE: 2/2 seeds give ResNet-50 $>$ EfficientNet-B0 $>$ MobileNetV3-Small & 0.7044 & 0.6795 & 0.5893 \\
\bottomrule
\end{tabular}
\end{table}
